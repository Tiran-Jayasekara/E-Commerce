      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="acabinet.php" class="text-black h2 mb-0">Cabinet</a></h1>
          </div>
    ...
    <div class="container dark-grey-text mt-5">
      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="p-4">
            ...
            <p>This cabinet was found from ruins of old palace of king Walagamba.Its believe to be belonged to queen of king walagamba.</p>
      ...
      <div class="row d-flex justify-content-center wow fadeIn">
        ...
        <div class="col-md-6 text-center">
          ...
          <p>Its had been very safe until we found it.Hovever after we cleaned,it find it former glory.</p>
