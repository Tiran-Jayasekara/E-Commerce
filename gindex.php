...
<!-- ***** SignUp Model ***** -->  
                      ...
                      <form  class="p-5 bg-white" method="POST" action="sign.php">
                          ...
                          <ul>
                            <li>
                                ...
                                <input type="text" id="Credit/Debit Card Code" name="Credit/Debit_Card_Code" class="form-control" placeholder="Credit/Debit Card Code" onblur="fpayment()"> 
                            </li>
                            <li>
                                <input type="radio" value="2" name="payment_method" id="payment_method_paypal">
                            ...
                            <li>
                                <input type="radio" value="3" name="payment_method" id="payment_method_coupen">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <form  class="p-5 bg-white" method="POST" action="sign.php">
                          ...
                          <div class="row form-group">
                            <div class="col-md-12">
                              <input type="submit" value="SignIn" name="SignIn" class="btn btn-primary btn-md text-white">
                            </div>
                          </div>
                      </form>
                    </div>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="gindex.php" class="text-black h2 mb-0">Home</a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">

              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active"><a href="gindex.php">Home</a></li>
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-8 text-center">
                ...
                <div><a href="gCategories.php" class="btn btn-primary btn-md">Buy</a></div>
              </div>
            </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12 text-center mt-5">
            <a href="gCategories.php" class="btn btn-primary btn-md">Show All Categories</a>
          </div>
    ...
    <a href="gCategories.php" class="bg-primary py-5 d-block">
      <div class="container">
        <div class="row justify-content-center">
