...
<!--     <meta charset="utf-8">
   ...
   <!--  <link href="https://fonts.googleapis.com/css?family=Quicksand:300,400,500,700,900" rel="stylesheet"> -->
    ...
    $("#aChangeaccount").click(function(){
        $("#Changeaccount").slideToggle("slow");
        }); 
    });
    $(document).ready(function(){
    $("#aChangepassword").click(function(){
        ...
        $(document).ready(function(){
    $("#aChangepayment").click(function(){
        $("#Changepayment").slideToggle("slow");
        });
    });
</script>
...
?>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php" class="text-black h2 mb-0">Home</a></h1>
          </div>
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-8 text-center">
                ...
                <div><a href="Categories.php" class="btn btn-primary btn-md">Buy</a></div>
              </div>
            </div>
    ...
    <section class="site-section">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="Relics/hairclip.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4">
            <a href="Relics/octagontable.php" class="media-1">
          ...
          <div class="col-md-6 col-lg-4">
            <a href="Relics/seththomasclock.php" class="media-1">
          ...
          <div class="col-12 text-center mt-5">
            <a href="Categories.php" class="btn btn-primary btn-md">Show All Categories</a>
          </div>
    ...
    <a href="Categories.php" class="bg-primary py-5 d-block">
      <div class="container">
        <div class="row justify-content-center">
