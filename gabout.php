                ...
                <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <form  class="p-5 bg-white" method="POST" action="sign.php">
                          ...
                          <div class="row form-group">
                            <div class="col-md-12">
                              <input type="submit" value="SignIn" name="SignIna" class="btn btn-primary btn-md text-white">
                            </div>
                          </div>
                      </form>
                    </div>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="gabout.php" class="text-black h2 mb-0">About</a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="active"><a href="gabout.php">About</a></li>
