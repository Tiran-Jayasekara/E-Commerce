                ...
                <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <form  class="p-5 bg-white" method="POST" action="sign.php">
                          ...
                          <div class="row form-group">
                            <div class="col-md-12">
                              <input type="submit" value="SignIn" name="SignInc" class="btn btn-primary btn-md text-white">
                            </div>
                          </div>
                      </form>
                    </div>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="gCategories.php" class="text-black h2 mb-0">Categories</a></h1>
          </div>
        ...
        <div class="row">
          <div class="col-md-4 col-lg-3 mb-3" data-aos="fade-up">
            <div class="p-3 box-with-humber">
              ...
              <h2>Wooden</h2>
              <a href="gWooden.php"><img src="images/Secret boxes.jpg" alt="Image" class="img-fluid" id="imgcat1"></a>
          ...
          <div class="col-md-4 col-lg-3 mb-3" data-aos="fade-up">
            <div class="p-3 box-with-humber">
              ...
              <h2>Metalic</h2>
              <a href="gMetalic.php"><img src="images/brass pot.jpg" alt="Image" class="img-fluid" id="imgcat1"></a>
          ...
          <div class="col-md-4 col-lg-3 mb-3" data-aos="fade-up">
            <div class="p-3 box-with-humber">
              ...
              <h2>Cerimic</h2>
              <a href="gCerimic.php"><img src="images/ceremic ball.jpg" alt="Image" class="img-fluid" id="imgcat1"></a>
           ...
           <div class="col-md-4 col-lg-3 mb-3" data-aos="fade-up">
            <div class="p-3 box-with-humber">
              ...
              <h2>Jewells</h2>
              <a href="gJewells.php"><img src="images/Necklace and saree clip.jpg" alt="Image" class="img-fluid" id="imgcat1"></a>
